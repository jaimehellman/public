...
const GridviewInline: React.FC<GridviewProps> = ({
    id,
    type,
    actionPosition,
    pagination,
        ...
        if( position == type){
            return (
                <td className="ctr actions">
                    <a><i onClick={() => saveInline()} className="fa fa-save"></i></a>
            ...
            if(!row.editting){
                return (
                    <td className="ctr actions">
                        ...
                        <a><i onClick={() => deleteInline(row)} className="fa fa-trash"></i></a>
                    </td>
                )
            }else{
                return (
